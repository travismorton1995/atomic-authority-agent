...
export const MENTIONS: Record<string, MentionEntry> = {
  ...
  'Cernavoda':                                 { searchTerm: 'Cernavoda',                  verified: true },
  ...
  'General Atomics':                           { searchTerm: 'General Atomics',            verified: true },
  ...
  'Idaho Falls':                               { searchTerm: 'Idaho Falls Power',          verified: true },
  ...
  'Nuclear Energy Agency':                     { searchTerm: 'Nuclear Energy Agency',      verified: true },
  ...
  'Organisation for Economic Co-operation and Development': { searchTerm: 'Organisation for Economic Co-operation and Development', verified: true },
  'PG&E':                                      { searchTerm: 'PG&E',                       verified: true },
  'Radiation and Public Health Project':       { searchTerm: 'Radiation and Public Health Project', verified: true },
  'RegLab':                                    { searchTerm: 'RegLab',                     verified: true },
  ...
  'Sierra Club':                               { searchTerm: 'Sierra Club',                verified: true },
  ...
  'University of Iowa':                        { searchTerm: 'University of Iowa',         verified: true },
  ...
  'University of Utah':                        { searchTerm: 'University of Utah',         verified: true },
