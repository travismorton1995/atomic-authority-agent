...
export const MENTIONS: Record<string, MentionEntry> = {
  ...
  'BMI':                                       { searchTerm: 'BMI',                        verified: true },
  ...
  'Clean Core':                                { searchTerm: 'Clean Core',                 verified: true },
  'CNA':                                       { searchTerm: 'Canadian Nuclear Association', verified: true },
  'CNL':                                       { searchTerm: 'Canadian Nuclear Laboratories', verified: true },
  'CSMC':                                      { searchTerm: 'Canadian Strategic Missions Corporation', verified: true },
  ...
  'Microsoft':                                 { searchTerm: 'Microsoft',                  verified: true },
  'Monark':                                    { searchTerm: 'Monark',                     verified: true },
  ...
  'Stern Laboratories':                        { searchTerm: 'Stern Laboratories',         verified: true },
  ...
  'Canadian Small Modular Reactor Consortium': { searchTerm: 'Canadian Small Modular Reactor Consortium', verified: false },
  'Cernavoda':                                 { searchTerm: 'Cernavoda',                  verified: false },
  'Claude Code':                               { searchTerm: 'Claude Code',                verified: false },
  'Congress':                                  { searchTerm: 'Congress',                   verified: false },
  'Czech':                                     { searchTerm: 'Czech',                      verified: false },
  'Governor Hochul':                           { searchTerm: 'Governor Hochul',            verified: false },
  'Idaho Falls':                               { searchTerm: 'Idaho Falls',                verified: false },
  'Indian Point':                              { searchTerm: 'Indian Point',               verified: false },
  'Kadmos Energy':                             { searchTerm: 'Kadmos Energy',              verified: false },
  'Massachusetts':                             { searchTerm: 'Massachusetts',              verified: false },
  'New England':                               { searchTerm: 'New England',                verified: false },
  'NPX Innovation':                            { searchTerm: 'NPX Innovation',             verified: false },
  'Nuclear Energy Agency':                     { searchTerm: 'Nuclear Energy Agency',      verified: false },
  'NYC':                                       { searchTerm: 'NYC',                        verified: false },
  'OECD':                                      { searchTerm: 'OECD',                       verified: false },
  'Organisation for Economic Co-operation and Development': { searchTerm: 'Organisation for Economic Co-operation and Development', verified: false },
  'RegLab':                                    { searchTerm: 'RegLab',                     verified: false },
  'Romania':                                   { searchTerm: 'Romania',                    verified: false },
  'South Korea':                               { searchTerm: 'South Korea',                verified: false },
  'TRISO':                                     { searchTerm: 'TRISO',                      verified: false },
  'Trump administration':                      { searchTerm: 'Trump administration',       verified: false },
  'Wall Street':                               { searchTerm: 'Wall Street',                verified: false },
};
