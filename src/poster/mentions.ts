...
export const MENTIONS: Record<string, MentionEntry> = {
  ...
  'DOE':                                       { searchTerm: 'U.S. Department of Energy ', verified: false },
  ...
  'NRC':                                       { searchTerm: 'Nuclear Regulatory Commission', verified: false },
  ...
  'Nuclear Regulatory Commission':             { searchTerm: 'Nuclear Regulatory Commission', verified: false },
  ...
  'Microsoft':                                 { searchTerm: 'Microsoft',                  verified: false },
  'MISO':                                      { searchTerm: 'MISO',                       verified: false },
